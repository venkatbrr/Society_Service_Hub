...
const CATEGORIES = [
  ...
  'Boutique', 'Movers & Packers', 'Teaching', 'RTO Agent', 'Aadhar Centre',
  'Pandit / Pujari', 'Mosquito Net / Screens', 'Balcony Safety Nets', 'Blinds & Curtains',
  'Core Cutting', 'False Ceiling / POP', 'Marble & Granite Work', 'Balcony Cloth Hangers',
  'Internet Provider / Tech', 'Washing Machine Repair', 'TV Repair & Install',
  'Swimming / Fitness Coach', 'Doctor / Clinic', 'Pharmacy Delivery', 'Diagnostics / Lab Tests',
  'Physiotherapy', 'Home Nurse / Nanny', 'Other'
];
...
const CATEGORY_MAPPING = {
  ...
  'mosquito net': 'Mosquito Net / Screens',
  'mosquito screens': 'Mosquito Net / Screens',
  'mesh': 'Mosquito Net / Screens',
  ...
  'pujari': 'Pandit / Pujari',
  'pandit': 'Pandit / Pujari',
  'priest': 'Pandit / Pujari',
  'panthulu': 'Pandit / Pujari',
  'medical': 'Doctor / Clinic',
  'pharmacy': 'Pharmacy Delivery',
  'nurse': 'Home Nurse / Nanny',
  'nanny': 'Home Nurse / Nanny',
  'physio': 'Physiotherapy',
  'doctor': 'Doctor / Clinic',
  'dr.': 'Doctor / Clinic',
  'swim': 'Swimming / Fitness Coach',
  'coach': 'Swimming / Fitness Coach',
  'trainer': 'Swimming / Fitness Coach',
  'internet': 'Internet Provider / Tech',
  'airtel': 'Internet Provider / Tech',
  'fiber': 'Internet Provider / Tech',
  'pioneer': 'Internet Provider / Tech',
  'core cutting': 'Core Cutting',
  'corecutting': 'Core Cutting',
  'fall ceiling': 'False Ceiling / POP',
  'ceiling': 'False Ceiling / POP',
  'granite': 'Marble & Granite Work',
  'marble': 'Marble & Granite Work',
  'hanger': 'Balcony Cloth Hangers',
