...
| **Cards** | In order: Pre-order Food & Community Business → `/mcn/drops` (open menus **not yet past their cutoff** + active listings) · Parent Corner → `/mcn/parents` (children listed) · Community Carpooling → `/mcn/carpools` (active rides) |
