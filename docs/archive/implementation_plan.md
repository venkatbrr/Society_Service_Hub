...
> **Historical reference**: this file captures the original build plan and early assumptions. It is not the source of truth for the current app surface. Use `docs/architecture.md`, `docs/features.md`, `docs/copilot-instructions.md`, `docs/cross-community.md`, and `.github/app-summary.md` for the current product state.
